...
PotentialPolicies = (
    ...
    (True, "Additional EV Subsidy Percentage[passenger,LDVs]","Additional EV Subsidy Percentage[passenger,LDVs]",[0,0.19],"Passenger Car ZEV Sales Standard"),
    ...
    (True, "Additional Minimum Required EV Sales Percentage[freight,LDVs]","Additional Minimum Required EV Sales Percentage[freight,LDVs]",[0,1],"Passenger Car ZEV Sales Standard"),
    ...
    (True, "Additional Minimum Required EV Sales Percentage[passenger,LDVs]","Additional Minimum Required EV Sales Percentage[passenger,LDVs]",[0,1],"California HDV Rules"),
    ...
    (True, "Boolean Ban New Power Plants[lignite es]","Boolean Ban New Power Plants[lignite es]",[0,1],"Power Sector Gas Regs"),
    (True, "Boolean Ban New Power Plants[natural gas nonpeaker es]","Boolean Ban New Power Plants[natural gas nonpeaker es]",[0,1],"Power Sector Coal Regs"),
    ...
    (True, "Percent of Travel Demand Shifted to Other Modes or Eliminated[freight,HDVs]","Percent of Travel Demand Shifted to Other Modes or Eliminated[freight,HDVs]",[0,0.063],"Passenger Mode Shifting"),
    (True, "Percent of Travel Demand Shifted to Other Modes or Eliminated[passenger,LDVs]","Percent of Travel Demand Shifted to Other Modes or Eliminated[passenger,LDVs]",[0,0.2],"Freight Logistics"),
